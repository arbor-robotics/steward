...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        proto_dot_std__msgs_dot_Header__pb2.DESCRIPTOR,
    ],
)
...
_IMAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="steward.Image.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="height",
            full_name="steward.Image.height",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="encoding",
            full_name="steward.Image.encoding",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="is_bigendian",
            full_name="steward.Image.is_bigendian",
            index=4,
            number=5,
            type=8,
            cpp_type=7,
...
_IMAGE.fields_by_name["header"].message_type = (
    proto_dot_std__msgs_dot_Header__pb2._HEADER
)
