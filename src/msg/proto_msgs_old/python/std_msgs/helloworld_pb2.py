...
# source: std_msgs/helloworld.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 5, 27, 2, "", "std_msgs/helloworld.proto"
)
