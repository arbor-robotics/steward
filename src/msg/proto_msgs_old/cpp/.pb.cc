...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ = {
  false, false, descriptor_table_protodef_, "", 2,
...
static bool dynamic_init_dummy_ = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_)), true);
